  ...
  return (
    <div className='section-container p-10 bg-pink-100'>
      <div className='section gap-16'>
        ...
        <div className='h-[520px] overflow-hidden rounded-xl group flex flex-row items-end justify-end'>
          <img
            src="/about-us.png"
            alt="Home Page Picture"
            className='w-[440px] h-full group-hover:scale-105 delayTime rounded-xl'
          />
        ...
        <div className='flex flex-col gap-8 max-w-[600px]'>
          ...
          <h2 className='sm:text-6xl font-bold text-4xl'>Financial Future with Expertise With</h2>
          ...
          <div className='flex flex-row gap-2'>
            ...
            <div>
              <span className='sm:text-4xl text-3xl'>Trusted Service</span>
          ...
          <div className='flex flex-row gap-2'>
            ...
            <div>
              <span className='sm:text-4xl text-3xl'>Consulting Group</span>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure minus, ipsum eveniet quam fugiat ab pariatur modi ipsam reprehenderit excepturi!</p>
            </div>
          </div>
          ...
          <div className='flex flex-row gap-2'>
            ...
            <div>
              <span className='sm:text-4xl text-3xl'>Wealth Advisors</span>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure minus, ipsum eveniet quam fugiat ab pariatur modi ipsam reprehenderit excepturi!</p>
            </div>
          </div>
